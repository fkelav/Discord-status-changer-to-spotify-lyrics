...
3. Name it anything, set the Redirect URI to: `http://127.0.0.1:23435/callback`
...
- Make sure the Redirect URI in your Spotify app settings is exactly `http://127.0.0.1:23435/callback`
